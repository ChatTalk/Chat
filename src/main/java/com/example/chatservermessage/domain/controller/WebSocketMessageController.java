...
public class WebSocketMessageController {
    ...
    public Mono<Void> enter(ChatMessageDTO.Enter enter, Principal principal) {
    ...
    public Mono<Void> message(ChatMessageDTO.Send send, Principal principal) {
        return Mono.fromRunnable(() -> {
    ...
    public Mono<Void> leave(ChatMessageDTO.Leave leave, Principal principal) {
        return Mono.fromRunnable(() -> {
